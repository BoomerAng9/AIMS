...
Date: 2026-09-24
Version: 2.0 (adds LOCALE as a candidate vertical validation target; records owner-supplied release blockers; does not change any model or agent assignment)
