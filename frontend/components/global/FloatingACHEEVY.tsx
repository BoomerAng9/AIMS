      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
            className="fixed z-50 flex flex-col rounded-2xl border border-slate-200 bg-white shadow-[0_16px_64px_rgba(0,0,0,0.12),0_4px_16px_rgba(0,0,0,0.06)]"
            style={{
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 flex-shrink-0">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg overflow-hidden border border-amber-200 bg-amber-50">
                  <img
                    src="/images/acheevy/acheevy-helmet.png"
                    alt="ACHEEVY"
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 scrollbar-thin bg-slate-50/50">
              {messages.length === 0 && (
                <div className="flex flex-col items-center justify-center h-full text-center opacity-60">
                  <div className="w-16 h-16 rounded-2xl overflow-hidden border border-amber-200 bg-amber-50 mb-4">
                    <img
                      src="/images/acheevy/acheevy-helmet.png"
                      alt="ACHEEVY"
                      className="w-full h-full object-cover"
                  ...
                  <p className="text-sm text-slate-600 font-medium">I&apos;m ACHEEVY, at your service.</p>
                  <p className="text-xs text-slate-400 mt-1">What will we deploy today?</p>
                </div>
              )}
            ...
            <div className="px-3 pb-3 pt-2 border-t border-slate-100 flex-shrink-0">
              <div className="flex items-center gap-2 rounded-xl bg-slate-50 border border-slate-200 px-3 py-2 focus-within:border-amber-300 focus-within:ring-2 focus-within:ring-amber-100 transition-all">
                <input
                  ref={inputRef}
                  type="text"
                  value={input}
