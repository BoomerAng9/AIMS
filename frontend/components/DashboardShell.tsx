...
export function DashboardShell({ children }: Props) {
  ...
  return (
    <LogoWallBackground mode="dashboard">
      ...
      <div className={`flex min-h-full bg-slate-100 ${IS_DEMO ? "pt-9" : "pt-[env(safe-area-inset-top)]"}`}>
        ...
        <div className="flex flex-1 flex-col min-h-full relative z-10">
          {/* Top bar */}
          <header className="sticky top-0 flex items-center justify-between border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur-xl sm:px-6 lg:px-8 xl:px-12 z-20 shadow-none">
