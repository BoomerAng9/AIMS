...
// to prevent repeated memory allocation and re-instantiation on every render.
...
export function FileDownload({
  ...
  const sizeKB = useMemo(
    // ⚡ Bolt Optimization: Prefer textEncoder.encode over new Blob().size
    // to avoid object instantiation overhead during string size calculation.
