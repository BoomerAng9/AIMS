...
// ⚡ Bolt: Optimize string byte size calculation
// Creating a TextEncoder instance once at the module level avoids
// repeated Blob object instantiation memory overhead on every render.
