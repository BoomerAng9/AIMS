...
export const AcheevyMessage = memo(({
  message: m,
  isLast,
  isLoading,
  isSpeaking,
  ...
  // Deep compare content to avoid re-renders during object reference changes
  return (
    ...
    prev.showPauseButton === next.showPauseButton
  );
});

AcheevyMessage.displayName = 'AcheevyMessage';
