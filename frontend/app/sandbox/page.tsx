    ...
    >
          ...
          {LIVE_PROJECTS.map((project) => (
            <motion.div key={project.slug} variants={staggerItem}>
              <Link
                ...
                className="group block p-6 h-full rounded-2xl border border-slate-100 bg-white hover:border-slate-200 hover:bg-white transition-all relative overflow-hidden"
              >
                {/* Icon */}
                <div
                ...
                {/* Content */}
                <h3 className="text-base font-medium text-slate-800 mb-1 group-hover:text-gold transition-colors">
                  {project.name}
                </h3>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {COMING_PROJECTS.map((project) => (
            <motion.div
              ...
              className="p-5 rounded-2xl border border-slate-100 bg-white opacity-60"
            >
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-3 text-xs text-slate-400">
          <div>
            <p className="text-slate-500 font-medium mb-1">Autonomous</p>
            <p>
          ...
          <div>
            <p className="text-slate-500 font-medium mb-1">ACHEEVY-Orchestrated</p>
            <p>
          ...
          <div>
            <p className="text-slate-500 font-medium mb-1">Evidence-Gated</p>
            <p>
