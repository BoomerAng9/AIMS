        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              export your deployment configurations at any time. To exercise these rights,
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              data is collected in aggregate to understand usage patterns and improve the platform.
            </p>
          </section>
