  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Doto:wght@100..900&family=Inter:wght@100..900&family=Caveat:wght@400..700&family=Permanent+Marker&display=swap"
          rel="stylesheet"
        />
      </head>
