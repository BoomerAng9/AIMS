...
export default function AboutPage() {
  return (
    <main className="flex flex-col min-h-full bg-[#F8FAFC] text-zinc-100">
      <SiteHeader />
      ...
      <section className="relative py-20 md:py-32 text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <motion.p
            ...
            className="text-sm text-zinc-500 max-w-2xl mx-auto leading-relaxed"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="flex items-start gap-3">
              ...
              <span className="text-zinc-500">The Executive Orchestrator you chat with &mdash; routes every task through the Chain of Command.</span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-cyan-400 font-bold text-xs mt-0.5">BOOMER_ANGS</span>
              <span className="text-zinc-500">Specialist agents that handle engineering, research, marketing, QA, and commerce.</span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-emerald-400 font-bold text-xs mt-0.5">CHICKEN HAWK</span>
              <span className="text-zinc-500">The execution engine that spawns Lil_Hawks and manages build pipelines.</span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-rose-400 font-bold text-xs mt-0.5">SOLAYNJ</span>
              <span className="text-zinc-500">The Architect of Form &mdash; the framework design principles that keep your deployments stable.</span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-amber-400 font-bold text-xs mt-0.5">THE ELDER</span>
              <span className="text-zinc-500">The pattern memory &mdash; every lesson learned from previous builds informs the next.</span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-zinc-500 font-bold text-xs mt-0.5">THE VOID</span>
              <span className="text-zinc-500">The enemy &mdash; the entropy, abandonment, and stagnation that we build against every day.</span>
            </div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="text-center py-16 border-t border-wireframe-stroke">
        <p className="text-sm text-zinc-500 mb-6">Ready to push The Void back and build something real?</p>
