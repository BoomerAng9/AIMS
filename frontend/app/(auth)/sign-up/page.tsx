        ...
        <>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className="flex flex-col items-center justify-center w-24 h-20 rounded-xl border border-white/8 bg-[#111113] hover:bg-[#18181B] hover:border-white/15 transition-all"
            >
              <svg className="w-5 h-5 mb-1.5 text-zinc-400" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
            ...
            <button
              ...
              className="flex flex-col items-center justify-center w-24 h-20 rounded-xl border border-white/8 bg-[#111113] hover:border-[#5865F2]/30 hover:bg-[#5865F2]/10 transition-all"
            >
              <svg
              ...
              <span className="text-[10px] text-zinc-400">Discord</span>
            </button>
          </div>
          ...
          {country && (
            <div className="rounded-xl border border-white/8 bg-[#111113] p-3">
              <p className="text-xs text-zinc-400">
                ...
                <span className="text-zinc-300">{country.timezone}</span>
              </p>
