      ...
      <form className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <label className="block text-xs text-amber-100/60">
            First Name
            <input type="text" className="mt-1 h-11 w-full rounded-xl border border-white/10 bg-black/60 px-3 text-sm text-amber-50 outline-none focus:border-amber-300 transition-all placeholder:text-white/15" placeholder="Jane" />
          </label>
          <label className="block text-xs text-amber-100/60">
            Last Name
            <input type="text" className="mt-1 h-11 w-full rounded-xl border border-white/10 bg-black/60 px-3 text-sm text-amber-50 outline-none focus:border-amber-300 transition-all placeholder:text-white/15" placeholder="Doe" />
          </label>
        </div>
        <label className="block text-xs text-amber-100/60">
          Email
          <input type="email" className="mt-1 h-11 w-full rounded-xl border border-white/10 bg-black/60 px-3 text-sm text-amber-50 outline-none focus:border-amber-300 transition-all placeholder:text-white/15" placeholder="you@example.com" />
        </label>
        <label className="block text-xs text-amber-100/60">
          Password
          <input type="password" className="mt-1 h-11 w-full rounded-xl border border-white/10 bg-black/60 px-3 text-sm text-amber-50 outline-none focus:border-amber-300 transition-all placeholder:text-white/15" placeholder="Create a password" />
        </label>
