        ...
        <>
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className="flex flex-col items-center justify-center w-24 h-20 rounded-xl border border-slate-200 bg-white hover:border-slate-200 hover:bg-slate-50 transition-all"
            >
              <svg className="w-5 h-5 mb-1.5 text-slate-600" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
            ...
            <button
              ...
              className="flex flex-col items-center justify-center w-24 h-20 rounded-xl border border-slate-200 bg-white hover:border-[#5865F2]/30 hover:bg-[#5865F2]/10 transition-all"
            >
              <svg
          ...
          {country && (
            <div className="rounded-xl border border-slate-200 bg-white p-3">
              <p className="text-xs text-slate-500">
                ...
                <span className="text-slate-700">{country.timezone}</span>
              </p>
