...
export default function MockDraftSurfacePage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-gold/30 pt-24 pb-16 px-4 md:px-8">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                >
                    ...
                    <motion.h1 variants={staggerItem} className="text-4xl md:text-6xl font-display text-white tracking-tight">
                        2026 NFL Mock Draft
                    </motion.h1>

                    <motion.p variants={staggerItem} className="text-base md:text-lg text-white/50 leading-relaxed font-sans max-w-2xl mx-auto">
                ...
                <motion.div
                    ...
                    className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-2xl border border-wireframe-stroke bg-black/50 backdrop-blur-md"
                >
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                disabled
                                className="pl-9 pr-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none focus:border-gold/30 transition-colors w-64"
                            />
                        </div>
                    </div>
                </motion.div>
                ...
                {loading ? (
                    <div className="text-center py-24">
                        ...
                        <p className="text-xs text-white/30 mt-4 font-mono uppercase tracking-widest">Syncing Draft Database...</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {prospects.map((p, idx) => (
                            <motion.div
                                ...
                                className="relative group rounded-2xl border border-white/[0.08] bg-black/40 hover:bg-[#111] overflow-hidden hover:border-gold/30 transition-all duration-300 shadow-xl"
                            >
                                ...
                                <div className="relative p-5 space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-3xl font-display text-white/20 group-hover:text-gold/20 transition-colors">
                                    ...
                                    {/* Player Info */}
                                    <div>
                                        <h3 className="text-xl font-bold text-white tracking-tight leading-tight group-hover:text-gold transition-colors font-sans">
                                            {p.firstName} {p.lastName}
                                        </h3>
                                        <div className="flex items-center gap-2 mt-2 text-sm text-white/50 font-mono">
                                    ...
                                    <div className="pt-4 flex items-end justify-between border-t border-white/5">
                                        <div>
                                            <p className="text-[10px] text-white/40 font-mono uppercase tracking-widest mb-1">P.A.I. Score</p>
                                        ...
                                        <div className="text-right">
                                            <p className="text-[10px] text-white/40 font-mono uppercase tracking-widest mb-1">NIL Est.</p>
