...
export default function ArenaLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-full flex flex-col bg-[#F8FAFC]">
      {/* Arena Top Bar */}
      <nav className="sticky top-0 z-50 flex items-center justify-between px-4 md:px-6 py-3 border-b border-wireframe-stroke bg-white/80 backdrop-blur-xl">
        <div className="flex items-center gap-4">
          ...
          <Link href="/arena" className="flex items-center gap-2">
            ...
            <span className="text-slate-800 font-display text-sm tracking-wider">THE ARENA</span>
          </Link>
        </div>

        {/* Nav Links */}
        <div className="flex items-center gap-1">
          <Link href="/arena" className="px-3 py-1.5 text-[0.6rem] font-mono uppercase tracking-widest text-slate-500 hover:text-gold transition-colors rounded-lg hover:bg-slate-50">
            Lobby
          </Link>
          <Link href="/arena/leaderboard" className="px-3 py-1.5 text-[0.6rem] font-mono uppercase tracking-widest text-slate-500 hover:text-gold transition-colors rounded-lg hover:bg-slate-50">
            Rankings
          </Link>
          <Link href="/arena/how-it-works" className="px-3 py-1.5 text-[0.6rem] font-mono uppercase tracking-widest text-slate-500 hover:text-gold transition-colors rounded-lg hover:bg-slate-50 hidden md:block">
            How It Works
          </Link>
      ...
      {/* Live Contest Ticker */}
      <div className="flex items-center gap-3 px-4 md:px-6 py-2 border-b border-wireframe-stroke bg-slate-100/60 overflow-x-auto scrollbar-hide">
        ...
        <div className="flex items-center gap-4 overflow-x-auto">
          <span className="text-[0.55rem] text-slate-400 font-mono whitespace-nowrap">
      ...
      {/* Footer */}
      <footer className="border-t border-wireframe-stroke px-6 py-6 bg-slate-100/60">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <span className="text-[0.5rem] font-mono text-slate-300 uppercase tracking-widest">
              The Arena by A.I.M.S.
            </span>
            <Link href="/arena/how-it-works" className="text-[0.5rem] font-mono text-slate-300 hover:text-gold/50 uppercase tracking-widest transition-colors">
              Rules
            </Link>
            <Link href="/arena/how-it-works#legal" className="text-[0.5rem] font-mono text-slate-300 hover:text-gold/50 uppercase tracking-widest transition-colors">
              Legal
            </Link>
          </div>
