...
// frontend/app/dashboard/make-it-mine/web-app/page.tsx
  ...
  return (
    <div className="max-w-lg mx-auto text-center space-y-6 py-12">
      ...
      <p className="text-slate-500">
        Web App Mode uses your camera to show your wireframes and your microphone for voice interaction.
        This allows ACHEEVY to provide real-time architecture guidance as you build.
      </p>
