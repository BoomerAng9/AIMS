...
const AI_MODELS: AIModel[] = [
  ...
  // Smart Assistants - General purpose helpers
  {
    ...
    capabilities: ['Reasoning', 'Analysis', 'Code', 'Vision', 'Long Context', 'Agentic'],
  ...
  },
  {
    ...
    capabilities: ['Reasoning', 'Code', 'Vision', 'Fast', 'Agentic'],
    pricing: 'pay-as-you-go',
    status: 'stable',
    contextWindow: '200K',
  ...
  },
  {
    ...
    capabilities: ['Fast', 'Efficient', 'Code', 'Vision'],
    pricing: 'pay-as-you-go',
    status: 'stable',
    contextWindow: '200K',
  ...
  },
  {
    ...
    provider: 'OpenAI',
    category: 'creative',
    description: 'Latest flagship model with advanced reasoning and multimodal',
    useCase: 'Best for: Complex creative projects, advanced reasoning, real-time interaction',
    capabilities: ['Vision', 'Audio', 'Reasoning', 'Code', 'Real-time'],
    pricing: 'pay-as-you-go',
    status: 'stable',
    contextWindow: '256K',
  ...
  // Research & Analysis
  {
    ...
    provider: 'Google',
    category: 'researcher',
    description: 'Ultra-fast thinking model with deep reasoning',
    useCase: 'Best for: Quick research, fact-checking, analyzing images',
    capabilities: ['Fast', 'Vision', 'Reasoning', 'Code', 'Thinking'],
    pricing: 'pay-as-you-go',
    status: 'stable',
    contextWindow: '2M',
    inputCost: '$0.50/M tokens',
  ...
  },
  {
    ...
    provider: 'Google',
    category: 'researcher',
    description: 'Massive context window for enterprise documents',
    useCase: 'Best for: Analyzing long documents, contracts, entire codebases',
    capabilities: ['Long Context', 'Vision', 'Code', 'Thinking', 'Agentic'],
    pricing: 'pay-as-you-go',
    status: 'stable',
    contextWindow: '4M',
  ...
  // Coding & Development
  {
    ...
    provider: 'DeepSeek',
    category: 'coder',
    description: 'Advanced reasoning model for code and math',
  ...
  },
  {
    ...
    provider: 'Mistral',
    category: 'coder',
    description: 'Next-gen code completion and generation',
  ...
  },
  {
    ...
    provider: 'Alibaba',
    category: 'specialist',
    description: 'Advanced multilingual model with extended capabilities',
