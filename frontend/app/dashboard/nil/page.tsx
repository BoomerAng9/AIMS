      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="text-sm font-normal text-zinc-400">Name, Image &amp; Likeness</span>
          </div>
...
function OverviewTab() {
  return (
    <div className="space-y-6">
      ...
      {/* Position Dynamics */}
      <div className="bg-[#111113] border border-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.3)] rounded-xl p-5">
...
function ValuationTab() {
  return (
    <div className="space-y-6">
      ...
      {/* Weight Bars */}
      <div className="bg-[#111113] border border-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.3)] rounded-xl p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {VALUATION_FACTORS.map(factor => {
          const colors = getColors(factor.color);
          return (
            <div key={factor.id} className={`bg-[#111113] shadow-[0_1px_2px_rgba(0,0,0,0.3)] border ${colors.border} rounded-xl p-5`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#111113] shadow-[0_1px_2px_rgba(0,0,0,0.3)] border border-amber-500/30 rounded-xl p-6">
        ...
        <div className="bg-[#1F1F23] border border-white/10 rounded-lg p-4 mb-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
          {PAI_FORMULA.components.map(comp => {
            ...
            return (
              <div key={comp.variable} className={`bg-[#18181B] border ${colors.border} rounded-lg p-4`}>
                <div className="flex items-center gap-2 mb-2">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        {/* Timeline line */}
        <div className="absolute left-[18px] top-4 bottom-4 w-px bg-[#1F1F23]" />
          ...
          {NIL_FOUNDATION.timeline.map((event, i) => (
            <div key={`${event.year}-${i}`} className="relative flex items-start gap-4 pl-1">
              ...
              <div className="relative z-10 mt-1.5">
                <div className="w-[14px] h-[14px] rounded-full bg-[#111113] border-2 border-amber-500/50 flex items-center justify-center">
                  <div className="w-[6px] h-[6px] rounded-full bg-amber-400" />
                </div>
              </div>

              {/* Content */}
              <div className="bg-[#111113] border border-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.3)] rounded-lg p-4 flex-1">
                <div className="flex items-center gap-2 mb-1">
