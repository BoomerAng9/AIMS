    ...
    <div className="space-y-6 animate-in fade-in duration-700">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {EVOLUTION_STAGES.map((stage) => (
                  <div key={stage.id} className="rounded-2xl border border-white/10 bg-black/40 p-4">
                    <div className="h-24 rounded-xl border border-white/5 bg-black/20 mb-3 flex items-center justify-center overflow-hidden relative">
                      <Image
                        src={stage.image}
                        alt={stage.visual}
                        fill
      ...
      <section className="rounded-3xl border border-white/10 bg-black/60 p-6 backdrop-blur-2xl">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          <div className="w-40 h-40 rounded-2xl border border-amber-300/20 bg-black/40 overflow-hidden shrink-0 flex items-center justify-center relative">
            <Image
