    ...
    <div className="wireframe-card p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-zinc-100">Shopping List</h2>
        </div>
        <button
          onClick={onAdd}
      ...
      {items.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-sm text-zinc-500">Add items for Boomer_Angs to scout</p>
          <p className="text-xs text-zinc-500 mt-1">They&apos;ll find the best prices across retailers</p>
        </div>
      ) : (
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <div className="flex items-center gap-1 bg-[#18181B] rounded-lg px-2 py-1">
                  ...
                  <input
                    ...
                    min="1"
                    className="w-10 bg-transparent text-sm text-zinc-100 text-center outline-none"
                  />
                </div>
                <div className="flex items-center gap-1 bg-[#18181B] rounded-lg px-2 py-1">
                  ...
                  <input
                    ...
                    placeholder="Max"
                    className="w-16 bg-transparent text-sm text-zinc-100 outline-none placeholder:text-zinc-500"
                  />
                </div>
                <button
  ...
  return (
    <div className="wireframe-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-100">Mission Preferences</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Budget */}
        <div>
          <label className="block text-xs text-zinc-500 mb-2">Total Budget</label>
          <div className="flex items-center gap-2 bg-white/3 border border-wireframe-stroke rounded-lg px-3 py-2">
            ...
            <input
              ...
              className="w-full bg-transparent text-zinc-100 text-sm outline-none"
              placeholder="500.00"
            />
          </div>
        </div>
        ...
        {/* Shipping Speed */}
        <div>
          <label className="block text-xs text-zinc-500 mb-2">Shipping</label>
              ...
              <button
                ...
                className={`flex-1 flex flex-col items-center gap-1 py-2 px-1 rounded-lg text-xs transition-all ${
                  shippingSpeed === opt.value
                    ...
                    : 'bg-white/3 text-zinc-500 border border-wireframe-stroke hover:bg-white/5'
                }`}
              >
        ...
        {/* Quality */}
        <div>
          <label className="block text-xs text-zinc-500 mb-2">Quality</label>
          <div className="flex gap-1">
            {([
  ...
  return (
    <div className="wireframe-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-100">Supported Retailers</h2>
      </div>
          ...
          <div
            ...
            className={`p-4 rounded-xl border transition-all ${
              retailer.enabled
                ...
                : 'bg-[#111113]/2 border-wireframe-stroke/50 opacity-60'
            }`}
          >
  ...
  return (
    <div className="wireframe-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-100">Deal Scout</h2>
        <span className="ml-auto text-xs text-zinc-500">AI-discovered deals</span>
      </div>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-zinc-100">{deal.product}</h3>
              ...
              <div className="text-right flex-shrink-0">
                <div className="text-sm text-zinc-500 line-through">${deal.originalPrice.toFixed(2)}</div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Boomer_Angs <strong className="text-zinc-400">never</strong> access payment info. They scout, compare, and report.
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-zinc-100">Buy in Bulk</h1>
            <p className="text-sm text-zinc-500">AI shopping assistant — deals at scale</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {!missionLaunched ? (
            ...
            <div className="wireframe-card p-8 text-center">
              ...
              <h2 className="text-xl font-bold text-zinc-100 mb-2">Mission Launched!</h2>
              ...
              <button
                ...
                className="mt-6 px-4 py-2 rounded-lg text-sm text-zinc-400 hover:text-zinc-100 border border-wireframe-stroke hover:bg-white/5 transition-all"
              >
                Start New Mission
              </button>
            </div>
      ...
      {activeTab === 'alerts' && (
        <div className="wireframe-card p-8 text-center">
          ...
          <h2 className="text-lg font-medium text-zinc-100 mb-2">Price Alerts</h2>
          <p className="text-sm text-zinc-500 max-w-md mx-auto mb-6">
      ...
      {activeTab === 'history' && (
        <div className="wireframe-card p-8 text-center">
          ...
          <h2 className="text-lg font-medium text-zinc-100 mb-2">Mission History</h2>
