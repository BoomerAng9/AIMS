    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <section className="rounded-3xl border border-wireframe-stroke bg-slate-50/70 p-6 backdrop-blur-2xl">
        ...
        <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-3 text-center">
            <p className="text-[10px] uppercase tracking-widest text-slate-400">Total Gates</p>
            <p className="text-xl font-bold text-slate-800 mt-1">{TOTAL}</p>
          </div>
          <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-3 text-center">
            <p className="text-[10px] uppercase tracking-widest text-slate-400">Pass Rate</p>
            <p className="text-xl font-bold text-emerald-400 mt-1">{PASS_PERCENTAGE}%</p>
          </div>
          <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-3 text-center">
            <p className="text-[10px] uppercase tracking-widest text-slate-400">Evidence</p>
            <p className="text-xl font-bold text-gold mt-1">{TOTAL_EVIDENCE}</p>
          </div>
          <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-3 text-center">
            <p className="text-[10px] uppercase tracking-widest text-slate-400">Deploy Ready</p>
            ...
            return (
              ...
              >
                ...
                <div className="absolute -top-2.5 -left-1 flex items-center gap-1.5">
                  <span className="rounded-full bg-white border border-wireframe-stroke px-2.5 py-0.5 text-[9px] font-bold text-gold uppercase tracking-wider">
                    Gate {gate.id}
                  </span>
                </div>
                ...
                <div className="flex items-start justify-between mt-2">
                  <div className="flex-1 pr-3">
                    <h3 className="text-sm font-semibold text-slate-800">{gate.name}</h3>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-red-400/60 mt-1 leading-relaxed">
              ...
              <code className="rounded bg-slate-50/70 border border-wireframe-stroke px-1.5 py-0.5 text-[10px] font-mono text-red-300/70">
                infra/vps-setup.sh
              </code>{" "}
              ...
              <button
                ...
                className={`rounded-full border px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider transition-colors ${
                  evidenceFilter === filter
                    ...
                    : "border-wireframe-stroke bg-slate-100/60 text-slate-400 hover:border-slate-200 hover:text-slate-500"
                }`}
              >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-wireframe-stroke">
                <th className="p-3 text-left text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  ID
                </th>
                <th className="p-3 text-left text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  Artifact
                ...
                <th className="p-3 text-center text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  Size
                </th>
                <th className="p-3 text-left text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  Signed By
                </th>
                <th className="p-3 text-right text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  Timestamp
                </th>
              </tr>
            </thead>
            <tbody>
              {filteredEvidence.length === 0 ? (
                <tr>
                  <td colSpan={7} className="p-8 text-center text-xs text-slate-300">
                ...
                filteredEvidence.map((artifact) => {
                  ...
                  return (
                    <tr
                      key={artifact.id}
                      className="border-t border-wireframe-stroke hover:bg-white transition-colors"
                    >
                      <td className="p-3">
                        <code className="rounded bg-slate-50/70 border border-wireframe-stroke px-2 py-0.5 text-[10px] font-mono text-gold">
                          {artifact.id}
                        </code>
                      </td>
                      <td className="p-3">
      ...
      <section className="rounded-3xl border border-wireframe-stroke bg-slate-50/70 p-6 backdrop-blur-2xl">
        ...
        <p className="mt-1 text-[0.65rem] text-slate-400 uppercase tracking-wider mb-4">
          ...
          {[
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-bold text-slate-500">{p.pillar}</span>
                  <span className="text-[10px] text-slate-800 font-medium truncate">{p.name}</span>
                </div>
                <span className="text-[9px] text-slate-300 font-mono">{p.gate}</span>
              </div>
            </div>
          ))}
        </div>
