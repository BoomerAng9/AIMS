  ...
  return (
    ...
    >
        ...
        <div className="rounded-3xl border border-wireframe-stroke bg-[#18181B]/70 p-6 backdrop-blur-2xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-wireframe-stroke bg-[#18181B]">
        ...
        <div className="rounded-3xl border border-wireframe-stroke bg-[#18181B]/70 p-6 backdrop-blur-2xl">
          ...
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">{repoStats.description}</p>
            </div>
          </div>
      ...
      <motion.section variants={staggerItem}>
        ...
        <div className="rounded-3xl border border-wireframe-stroke bg-[#18181B]/70 backdrop-blur-2xl divide-y divide-white/5">
          {recentCommits.map((commit) => (
            <div key={commit.hash} className="flex items-start gap-4 px-6 py-4">
              {/* Commit Hash */}
              <code className="mt-0.5 flex-shrink-0 rounded-lg border border-wireframe-stroke bg-[#18181B] px-2 py-0.5 text-xs font-mono text-gold/80">
                {commit.hash}
              </code>

              {/* Message + Meta */}
              <div className="min-w-0 flex-1">
                <p className="text-sm text-zinc-100 truncate">{commit.message}</p>
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <GitBranch
                    size={14}
                    className={
                      branch.isDefault ? "text-gold" : "text-zinc-500"
                    }
                  />
              ...
              (label, i) => (
                <p
                  ...
                  className={`flex-1 text-center text-[9px] ${
                    i === 11 ? "text-gold/70" : "text-zinc-600"
                  }`}
                >
                  {label}
                </p>
