                            ...
                            >
                                ...
                                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setIsSubmitting(true); setTimeout(() => { setIsSubmitting(false); setShowSubmitForm(false); }, 2000); }}>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 bg-purple-500 hover:bg-purple-400 text-white font-mono font-bold uppercase tracking-widest text-xs rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
                                        {isSubmitting ? (
