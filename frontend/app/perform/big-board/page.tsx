            ...
            filtered.map((prospect, index) => {
              ...
              return (
                <Link
                  ...
                  className={`group grid grid-cols-1 md:grid-cols-[80px_2fr_100px_1fr_1fr_120px_100px_100px_40px] gap-4 px-6 py-5 items-center hover:bg-slate-50 transition-all relative ${isPrime ? 'bg-gold/[0.02]' : ''
                    }`}
                >
