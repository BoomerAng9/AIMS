...
const NEEDS_QUESTIONS = [
  ...
  // Technical
  { id: 'existing-tools', section: 'technical', question: 'What tools do you currently use?', type: 'multi-select', options: ['slack', 'microsoft-teams', 'google-workspace', 'notion', 'jira', 'salesforce', 'hubspot', 'shopify', 'quickbooks', 'stepper', 'n8n', 'airtable', 'zoho', 'paperform', 'none'], required: false },
