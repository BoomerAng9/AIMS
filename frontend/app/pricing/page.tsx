    ...
    <main className="min-h-screen bg-[#F8FAFC] text-slate-800">
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mb-14">
          ...
          <div className="overflow-x-auto rounded-3xl border border-wireframe-stroke bg-slate-50/70 backdrop-blur-2xl">
            <table className="w-full min-w-[750px]">
              <thead>
                <tr>
                  <th className="p-4 text-left text-xs uppercase tracking-widest text-slate-400 border-b border-wireframe-stroke">
                    Group \ Frequency
                  </th>
                  {subscriptionTiers.map((tier) => (
                    <th
                      ...
                      className={`p-4 text-center border-b border-wireframe-stroke cursor-pointer transition-colors ${
                        selectedTier === tier.id ? "bg-gold/5" : "hover:bg-white"
                      }`}
                ...
                {GROUP_STRUCTURES.map((group, gi) => (
                  ...
                  >
                    <td className="p-4 border-t border-wireframe-stroke">
                      ...
                      <p className="text-xs text-slate-400">{group.seats} seats</p>
                      {group.multiplier > 0 && (
                        ...
                        >
                          {group.id === "enterprise-group" ? (
                            ...
                            <>
                              ...
                              <p className="text-[9px] text-slate-400">/mo w/ pillars</p>
                            </>
                          )}
                        </td>
                      );
          ...
          {/* P2P row */}
          <div className="mt-3 rounded-2xl border border-wireframe-stroke bg-slate-50/70 p-4 flex items-center justify-between flex-wrap gap-3">
              ...
              <button
                ...
                className={`rounded-full px-4 py-1.5 text-xs font-semibold transition-all ${
                  selectedTier === "p2p"
                    ...
                    : "border border-wireframe-stroke text-slate-600 hover:border-slate-200"
                }`}
              >
                Pay-per-Use
              </button>
              <span className="text-xs text-slate-600">No commitment &middot; {commitmentLabels["p2p"]}</span>
            </div>
            <div className="flex items-center gap-6 text-xs">
              <span className="text-slate-600">
                100 tokens / <span className="text-slate-800 font-semibold">$1</span>
              </span>
              <span className="text-emerald-400/70 font-semibold">Metered agents &middot; 1 concurrent</span>
              <span className="text-slate-600">Pay-as-you-go</span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {PILLARS.map((pillar) => {
              ...
              return (
                <div key={pillar.id} className="rounded-3xl border border-wireframe-stroke bg-slate-50/70 backdrop-blur-2xl overflow-hidden">
                  {/* Pillar Header */}
                  <div className="p-5 border-b border-wireframe-stroke bg-gradient-to-r from-gold/5 to-transparent">
                    <div className="flex items-center gap-2">
                      <span className="text-lg">{pillar.icon}</span>
                      <h3 className="text-base font-bold text-slate-800">{pillar.name}</h3>
                    </div>
                    <p className="text-xs text-slate-600 mt-1">{pillar.tagline}</p>
                  </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <span className={`text-sm font-semibold ${isSelected ? "text-gold" : "text-slate-800"}`}>
                            {option.name}
                          </span>
                        ...
                        <ul className="space-y-1">
                          {option.features.map((f, i) => (
                            <li key={i} className="text-xs text-slate-600 flex items-start gap-1.5">
                              <span className={`mt-0.5 ${isSelected ? "text-gold/60" : "text-slate-400"}`}>
                                {isSelected ? "\u2713" : "\u2022"}
                              </span>
                              {f}
                            </li>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-wireframe-stroke">
                  <th className="p-4 text-left text-xs uppercase tracking-widest text-slate-400">
                    Task / Automation Type
                  </th>
                  <th className="p-4 text-center text-xs uppercase tracking-widest text-slate-400">
                    Multiplier
                  </th>
                  <th className="p-4 text-left text-xs uppercase tracking-widest text-slate-400">
                    Description
                  </th>
                  <th className="p-4 text-center text-xs uppercase tracking-widest text-slate-400 w-48">
                    Your Weight
                  </th>
                </tr>
              </thead>
              ...
              <tfoot>
                <tr className="border-t border-gold/10 bg-gold/[0.03]">
                  ...
                  <td className="p-4 text-xs text-slate-600" colSpan={2}>
        ...
        <section className="mb-14">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-50/70 p-5">
              <p className="text-xs uppercase tracking-widest text-slate-600 mb-2">
                Overage Rate
              </p>
              <p className="text-xl font-bold text-slate-800">
                ${USAGE_MODIFIERS.overageRatePer1K}
                <span className="text-xs text-slate-600 font-normal"> / 1K tokens</span>
              </p>
            ...
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-50/70 p-5">
              ...
              <div className="space-y-1 mt-2">
                <p className="text-sm text-slate-600">
                  <span className="text-slate-800 font-semibold">${USAGE_MODIFIERS.maintenanceFee.toFixed(2)}</span> maintenance / invoice
                </p>
                <p className="text-sm text-slate-600">
                  <span className="text-slate-800 font-semibold">${USAGE_MODIFIERS.p2pTransactionFee.toFixed(2)}</span> per P2P transaction
                </p>
            ...
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-50/70 p-5">
              ...
              <p className="text-xl font-bold text-slate-800">
                ...
                <span className="text-xs text-slate-600 font-normal"> convenience</span>
              </p>
              <p className="text-xs text-slate-400 mt-1">On-demand during high demand</p>
            </div>
        ...
        <section className="mb-14">
          ...
          <div className="overflow-x-auto rounded-3xl border border-wireframe-stroke bg-slate-50/70 backdrop-blur-2xl">
            <table className="w-full min-w-[800px]">
              <thead>
                <tr className="border-b border-wireframe-stroke">
                  <th className="p-3 text-left text-xs uppercase tracking-widest text-slate-400">Platform</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Price</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Unit</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Allocation</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Agents</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Concurrent</th>
                  <th className="p-3 text-center text-xs uppercase tracking-widest text-slate-400">Security</th>
                </tr>
              </thead>
              <tbody>
                {(["workspace", "coding", "builder"] as Cluster[]).map((cluster) => (
                  <React.Fragment key={cluster}>
                    {/* Cluster header */}
                    <tr className="border-t border-wireframe-stroke bg-white">
                    ...
                    {competitors.filter((c) => c.cluster === cluster).map((c) => (
                      <tr key={c.name} className="border-t border-wireframe-stroke text-slate-600">
                        ...
                        <td className="p-2.5 text-xs text-center">
                          <span className="rounded-full bg-slate-50 px-1.5 py-0.5 text-[9px]">{c.unit}</span>
                        </td>
                ...
                {subscriptionTiers.map((tier) => (
                  <tr key={tier.id} className="border-t border-gold/20 bg-gold/[0.03]">
                    ...
                    <td className="p-2.5 text-xs text-center font-semibold text-slate-800">
                      ${tier.monthlyPrice}/mo
                    </td>
                    <td className="p-2.5 text-xs text-center">
                      <span className="rounded-full bg-gold/10 px-1.5 py-0.5 text-[9px] text-gold font-semibold">Tokens</span>
                    </td>
                    <td className="p-2.5 text-xs text-center text-slate-800">
                      {(tier.tokensIncluded / 1000).toFixed(0)}K tokens
                    </td>
          ...
          <p className="mt-3 text-xs text-slate-400 text-center">
            A.I.M.S. anchors on <strong className="text-slate-600">tokens</strong> — transparent, measurable, and optimized by ByteRover pattern reuse (15-40% savings).
        ...
        <section className="mb-14">
          ...
          <p className="text-sm text-slate-600 max-w-3xl mx-auto text-center mb-8">
            ...
            {WHITE_LABEL_PLANS.map((plan, i) => (
              <div
                ...
                className={`relative rounded-3xl border p-6 backdrop-blur-2xl transition-all hover:scale-[1.01] ${
                  i === 2
                    ? "border-gold/30 bg-gradient-to-br from-gold/5 to-white/80 shadow-[0_0_40px_rgba(251,191,36,0.08)]"
                    : "border-wireframe-stroke bg-slate-50/70"
                }`}
              >
                {i === 2 && (
                ...
                <p className="text-[9px] text-slate-400 mt-0.5">Custom quote based on scale</p>
        ...
        {/* ═══════════════════════════════════════════════════════════════
            ...
            ═══════════════════════════════════════════════════════════════ */}
        <section className="rounded-3xl border border-gold/30 bg-gradient-to-br from-gold/5 to-white/80 p-8 shadow-[0_0_60px_rgba(251,191,36,0.1)]">
            ...
            {(selectedGroup === "team" || selectedGroup === "enterprise-group") && (
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  min={1}
                  className="w-16 rounded-lg border border-wireframe-stroke bg-slate-50/70 px-2 py-1 text-sm text-slate-800 text-center outline-none focus:border-gold"
                />
              </div>
            )}
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
            {/* Frequency */}
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-4">
              <p className="text-xs uppercase tracking-wider text-slate-600">Frequency</p>
              <p className="text-lg font-bold text-slate-800 mt-1">{bill.baseTier.name}</p>
              <p className="text-xs text-slate-400 mt-0.5">
            ...
            {/* Group */}
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-4">
              <p className="text-xs uppercase tracking-wider text-slate-600">Group</p>
              <p className="text-lg font-bold text-slate-800 mt-1">{bill.group.name}</p>
              <p className="text-xs text-slate-400 mt-0.5">
            ...
            {/* Task Mix */}
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-4">
              <p className="text-xs uppercase tracking-wider text-slate-600">Task Mix</p>
              <p className="text-lg font-bold text-slate-800 mt-1">{bill.effectiveMultiplier}x</p>
              <p className="text-xs text-slate-400 mt-0.5">Effective multiplier</p>
            </div>

            {/* Pillars */}
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-4">
              <p className="text-xs uppercase tracking-wider text-slate-600">Pillars</p>
            ...
            {/* Commitment Total */}
            <div className="rounded-2xl border border-wireframe-stroke bg-slate-100/60 p-4">
              <p className="text-xs uppercase tracking-wider text-slate-600">Commitment</p>
              <p className="text-lg font-bold text-slate-800 mt-1">
        ...
        <section className="mt-16 text-center">
          ...
          <p className="text-base text-slate-600 max-w-lg mx-auto leading-relaxed">
            ...
            <strong className="text-slate-800"> 9</strong> is completion —
