...
module.exports = {
  content: [
    ...
    './node_modules/agentic-ui/dist/**/*.{js,mjs,jsx}',
  ],
  theme: {
    extend: {
      colors: {
      ...
      boxShadow: {
        ...
        'neon-gold': '0 4px 14px rgba(217, 119, 6, 0.2)',
        'neon-violet': '0 4px 14px rgba(217, 119, 6, 0.2)',
        'neon-cyan': '0 4px 14px rgba(6, 182, 212, 0.2)',
        'neon-blue': '0 4px 14px rgba(59, 130, 246, 0.2)',
        'glow-gold': '0 4px 14px rgba(217, 119, 6, 0.15)',
        'glow-gold-soft': '0 2px 8px rgba(217, 119, 6, 0.08)',
        'glow-violet': '0 4px 14px rgba(217, 119, 6, 0.15)',
        'wireframe-inner': '0 1px 2px rgba(0,0,0,0.3)',
        'card-lift': '0 4px 16px rgba(0,0,0,0.4), 0 1px 4px rgba(0,0,0,0.3)',
        'glow-controlled': '0 2px 8px rgba(217, 119, 6, 0.06)',
      ...
      keyframes: {
        ...
        pulse_gold: {
          ...
          '50%': { opacity: '0.85', boxShadow: '0 0 16px rgba(217,119,6,0.25)' },
        },
        connector_pulse: {
          '0%, 100%': { opacity: '0.3' },
          '50%': { opacity: '0.6' },
