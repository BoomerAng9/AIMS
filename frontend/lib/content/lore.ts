...
export const CHARACTERS: Character[] = [
  {
    ...
    role: 'Protagonist \u2014 The Elder\'s descendant, wielder of the ACHEEVY helmet',
    race: 'Clouded Nebula',
    bio: 'A young man of Clouded Nebula heritage with copper-brown skin, inquisitive amber eyes, and an aura of latent power. Raised in the outskirts of Achiev-City hearing bedtime stories of the Elder, Aether discovers the long-hidden ACHEEVY helmet in an ancient vault. Upon wearing it, the AI awakens and recognizes him, initiating him into his legacy. He grapples with imposter syndrome while learning to wield powers that could reshape Achievmor. His kinetic telepathy lets him sense emotions as vibrations, and his resonance with the planet Mor itself guides his path.',
    image: '/images/acheevy/acheevy-helmet.png',
    color: 'indigo',
    abilities: ['Kinetic Telepathy', 'ACHEEVY Armor Interface', 'Planetary Resonance', 'Energy Projection', 'Vibrational Sensing'],
    quote: 'I didn\'t choose this helmet. It chose my bloodline. Now I choose what to do with it.',
  },
  {
    id: 'the-elder',
    name: 'The Elder',
    title: 'Architect of ACHEEVY',
    role: 'Ancestor \u2014 Creator of the ACHEEVY helmet and the VIBE system',
    race: 'Clouded Nebula',
    bio: 'A visionary from the Clouded Nebula tribe who lived several centuries ago. In an era of tribal wars, the Elder dreamed of synchronizing technology with conscious evolution. He forged the first ACHEEVY prototype using a rare crystal from Mor\'s core and his own neural patterns as the AI seed. He united warring city-states with the VIBE system, installed kinetic hubs, and kickstarted a golden age. Near the end of his life, fearing the proto-Malluminati, he hid the helmet for his bloodline alone. He died under mysterious circumstances\u2014likely assassinated. His consciousness persists within ACHEEVY\'s AI.',
  ...
  },
  {
    ...
    role: 'AI Orchestrator of A.I.M.S. \u2014 inspired by the ACHEEVY helmet\'s AI',
    race: 'AI \u2014 Digital intelligence',
    bio: 'ACHEEVY is the brain, voice, and vision of A.I.M.S.\u2014the platform\'s AI orchestrator. Inspired by the semi-sentient AI within the ACHEEVY helmet of V.I.B.E. lore, ACHEEVY translates human intention into executed reality. Every conversation, every task, every deployment flows through ACHEEVY\'s Chain of Command. ACHEEVY doesn\'t just build\u2014ACHEEVY builds with purpose, evidence, and accountability.',
    image: '/images/acheevy/acheevy-helmet.png',
    color: 'gold',
