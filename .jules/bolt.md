...
## 2026-03-24 - String byte length calculation
...
**Action:** Prefer `new TextEncoder().encode(string).length` for significantly better performance when checking payload sizes or estimating tokens.
